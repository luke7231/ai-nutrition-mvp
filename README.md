...
**배포된 서비스**: [https://ai-nutrition-mvp.vercel.app](https://ai-nutrition-mvp.vercel.app)
...
현재 MVP는 **영양제 입문자의 첫 걸음**을 돕는 데 집중한 프로덕트. 

하지만 사용자가 초심자 단계를 넘어서면, 더 디테일한 문제에 직면하게 됩니다:

- **성분 비교의 복잡성**
- **제품 간 상세 비교**

이러한 문제들은 AI가 매우 잘 해결할 수 있다고 믿습니다. 예를 들어, 사용자가 "이 제품과 저 제품 중 어떤 게 나에게 더 맞을까?"라는 질문을 할 때, AI가 개인의 상황(나이, 성별, 증상, 기존 복용 약물 등)을 종합적으로 분석하여 객관적인 비교 분석을 제공할 수 있습니다.

이 부분을 MVP에 포함하지 못한 것이 가장 아쉽습니다. 이는 서비스의 핵심 가치 확장 포인트이며, 초기 사용자로부터 좋은 지표가 나온다면 가장 우선적으로 구현하고 싶은 기능.


### 좋았던 점
사적인 것이긴 하나, 프로덕트 나오기 전에 더 작게 검증할 방법 없을까 생각하다가,
어머니한테 문제 해결한답시고, 카톡으로 프리토타이핑 했는데, 성공해서 확신얻고 MVP 개발할 수 있었던 점.

앞으로도 더 작게 검증하는 방법을 기본 셋으로 장착해야함.

| 추천 단계 | 추천 흐름 | 대화 자료 |
|----------|----------|----------|
| 1단계 | 내가 엄마를 추천 | ![](https://github.com/user-attachments/assets/73ef9198-63e3-424b-8e83-33d0417cf563) |
| 2단계 | 엄마가 양아버지를 추천 | ![](https://github.com/user-attachments/assets/7a18e2c9-4a69-43ae-8cdf-7eefa18d31f3) |
